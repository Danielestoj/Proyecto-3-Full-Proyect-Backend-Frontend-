...
-- CreateEnum
CREATE TYPE "MovementType" AS ENUM ('IN', 'OUT', 'RESERVED', 'RELEASED');

-- CreateEnum
CREATE TYPE "ProductAvailability" AS ENUM ('PREORDER', 'IN_STOCK', 'BACKORDER', 'OUT_OF_STOCK');

-- CreateEnum
CREATE TYPE "OrderStatus" AS ENUM ('PENDING', 'PAID', 'PROCESSING', 'SHIPPED', 'DELIVERED', 'CANCELLED', 'REFUNDED');

-- CreateEnum
CREATE TYPE "ProductLanguage" AS ENUM ('ENGLISH', 'SPANISH', 'JAPANESE', 'FRENCH', 'GERMAN', 'ITALIAN', 'PORTUGUESE', 'KOREAN', 'CHINESE');

-- CreateEnum
CREATE TYPE "ProductCondition" AS ENUM ('MINT', 'NEAR_MINT', 'EXCELLENT', 'GOOD', 'LIGHT_PLAYED', 'PLAYED', 'POOR');
...
-- AddForeignKey
ALTER TABLE "ProductPriceHistory" ADD CONSTRAINT "ProductPriceHistory_productVariantId_fkey" FOREIGN KEY ("productVariantId") REFERENCES "ProductVariant"("id") ON DELETE CASCADE ON UPDATE CASCADE;
